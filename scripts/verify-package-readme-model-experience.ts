...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-sidebar-artifact-preview': { kind: 'none', reason: 'Browser-only rendered file viewer; registers no tool, prompt section, or session event, and what the user reads never enters a model request.' },
  ...
  'packages/bundle/artifact-viewers': { kind: 'none', reason: 'The bundle inserts a browser-only rendered file viewer and carries no model-facing row itself.' },
